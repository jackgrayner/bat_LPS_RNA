...
#nb bat sequences from Li et al. 2022, Ecol & Evol
#mammal seqs from mirbase
/mnt/apps/users/jrayner/conda/envs/mirdeep2/bin/mapper.pl all_collapsed.fa -c -o 8 -h -i -j -m -s all_collapsed.fa -t all_collapsed.arf -p ../phha
