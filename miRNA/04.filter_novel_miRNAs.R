...
#assign random IDs
nov$Ph_ID<-paste0("phha-miR-",c(1000:(999+nrow(nov))))
...
write.csv(nov[,c("Ph_ID","consensus.precursor.sequence")],file="novel_pha_rnas_filtered_precursor.csv",row.names=FALSE,quote=FALSE)
write.csv(nov[,c("Ph_ID","consensus.mature.sequence")],file="novel_pha_rnas_filtered_mature.csv",row.names=FALSE,quote=FALSE)
